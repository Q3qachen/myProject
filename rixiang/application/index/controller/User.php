...
class User extends Frontend
{
    ...
    public function register()
    {
        ...
        if ($this->request->isPost()) {
            ...
            $tion_code =  $this->request->post('tion_code');
            $rule = [
            ...
            $tion_codes = Db::name('tion')->where('tion_code',$tion_code)->find();
          ...
          // 随机选择一个单词的索引
            ...
            $randomWord = $words[$randomIndex];//随机生成英语单词
            if (!$result) {
                $this->error(__($validate->getError()), null, ['token' => $this->request->token()]);
            }
            if ($this->auth->register($randomWord, $password, '', $mobile,array('tion_code'=>$tion_code))) {
