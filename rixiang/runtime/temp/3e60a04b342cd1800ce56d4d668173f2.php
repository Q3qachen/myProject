<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:59:"C:\achen\phpstudy\WWW\h5\addons\cms\view\default\index.html";i:1774836475;s:67:"C:\achen\phpstudy\WWW\h5\addons\cms\view\default\common\layout.html";i:1746782824;s:69:"C:\achen\phpstudy\WWW\h5\addons\cms\view\default\common\userinfo.html";i:1746782588;s:68:"C:\achen\phpstudy\WWW\h5\addons\cms\view\default\common\sidebar.html";i:1733193921;}*/ ?>
<!DOCTYPE html>
<html class="">
<head>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav" data-current="<?php echo (isset($__CHANNEL__['id']) && ($__CHANNEL__['id'] !== '')?$__CHANNEL__['id']:0); ?>">
                    ...
                    <?php $__dKo0CSMwzH__ = \addons\cms\model\Channel::getChannelList(["id"=>"nav","type"=>"top","condition"=>"1=isnav"]); if(is_array($__dKo0CSMwzH__) || $__dKo0CSMwzH__ instanceof \think\Collection || $__dKo0CSMwzH__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__dKo0CSMwzH__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
                    <!--判断是否有子级或高亮当前栏目-->
                    <li class="<?php if($nav['has_child']): ?>dropdown<?php endif; if($nav->is_active): ?> active<?php endif; ?>">
                        ...
                        <ul class="dropdown-menu <?php if(!$nav['has_nav_child']): ?>hidden<?php endif; ?>" role="menu">
                            <?php $__0EeBqc8P3r__ = \addons\cms\model\Channel::getChannelList(["id"=>"sub","type"=>"son","typeid"=>$nav['id'],"condition"=>"1=isnav"]); if(is_array($__0EeBqc8P3r__) || $__0EeBqc8P3r__ instanceof \think\Collection || $__0EeBqc8P3r__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__0EeBqc8P3r__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sub): $mod = ($i % 2 );++$i;?>
                            <li><a href="<?php echo $sub['url']; ?>"><?php echo htmlentities($sub['name'] ?? ''); ?></a></li>
                            <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__0EeBqc8P3r__; ?>
                            
                        </ul>
                    </li>
                    <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__dKo0CSMwzH__; ?>
            ...
            <div class="swiper-container index-focus">
                ...
                <div id="index-focus" class="carousel slide carousel-focus" data-ride="carousel">
                    <ol class="carousel-indicators">
                        <?php $__rxLXDvVf52__ = \addons\cms\model\Block::getBlockList(["id"=>"block","name"=>"indexfocus","row"=>"5"]); if(is_array($__rxLXDvVf52__) || $__rxLXDvVf52__ instanceof \think\Collection || $__rxLXDvVf52__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__rxLXDvVf52__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$block): $mod = ($i % 2 );++$i;?>
                        <li data-target="#index-focus" data-slide-to="<?php echo $i-1; ?>" class="<?php if($i==1): ?>active<?php endif; ?>"></li>
                        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__rxLXDvVf52__; ?>
                    </ol>
                    <div class="carousel-inner" role="listbox">
                        <?php $__JSpvaB4Q5Y__ = \addons\cms\model\Block::getBlockList(["id"=>"block","name"=>"indexfocus","row"=>"5"]); if(is_array($__JSpvaB4Q5Y__) || $__JSpvaB4Q5Y__ instanceof \think\Collection || $__JSpvaB4Q5Y__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__JSpvaB4Q5Y__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$block): $mod = ($i % 2 );++$i;?>
                        ...
                        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__JSpvaB4Q5Y__; ?>
                    </div>
            ...
            <div class="panel panel-default lasest-update">
                ...
                <div class="panel-body">
                    <ul class="list-unstyled">
                        <?php $__eGtkimoJD9__ = \addons\cms\model\Archives::getArchivesList(["id"=>"new","row"=>"8","orderby"=>"id","orderway"=>"desc"]); if(is_array($__eGtkimoJD9__) || $__eGtkimoJD9__ instanceof \think\Collection || $__eGtkimoJD9__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__eGtkimoJD9__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?>
                        <li>
                        ...
                        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__eGtkimoJD9__; ?>
                    </ul>
                </div>
                <!-- E 最近更新 -->
            </div>
...
<!--    </div>-->
<!--    <div class="panel-body">-->
<!--        <?php $__MAPgGNkHqs__ = \addons\cms\model\Archives::getArchivesList(["id"=>"item","model"=>"1","row"=>"10","flag"=>"recommend","orderby"=>"id","orderway"=>"asc"]); if(is_array($__MAPgGNkHqs__) || $__MAPgGNkHqs__ instanceof \think\Collection || $__MAPgGNkHqs__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__MAPgGNkHqs__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>-->
...
<!--            </div>-->
<!--        </div>-->
<!--        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__MAPgGNkHqs__; ?>-->
<!--    </div>-->
<!--</div>-->
<!--&lt;!&ndash; E 热门资讯 &ndash;&gt;-->
...
<!--    <div class="panel-body">-->
<!--        <div class="tags">-->
<!--            <?php $__5s7EbFU9ai__ = \addons\cms\model\Tag::getTagList(["id"=>"tag","orderby"=>"rand","limit"=>"30"]); if(is_array($__5s7EbFU9ai__) || $__5s7EbFU9ai__ instanceof \think\Collection || $__5s7EbFU9ai__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__5s7EbFU9ai__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tag): $mod = ($i % 2 );++$i;?>-->
<!--            <a href="<?php echo $tag['url']; ?>" class="tag"> <span><?php echo htmlentities($tag['name'] ?? ''); ?></span></a>-->
<!--            <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__5s7EbFU9ai__; ?>-->
<!--        </div>-->
<!--    </div>-->
<!--</div>-->
<!--&lt;!&ndash; E 热门标签 &ndash;&gt;-->
...
<!--    </div>-->
<!--    <div class="panel-body">-->
<!--        <?php $__L4gHxnmPDt__ = \addons\cms\model\Archives::getArchivesList(["id"=>"item","model"=>"3","row"=>"10","flag"=>"recommend","orderby"=>"id","orderway"=>"asc"]); if(is_array($__L4gHxnmPDt__) || $__L4gHxnmPDt__ instanceof \think\Collection || $__L4gHxnmPDt__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__L4gHxnmPDt__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>-->
<!--        <div class="media media-number">-->
<!--            <div class="media-left">-->
<!--                <span class="num tag"><?php echo $i; ?></span>-->
<!--            </div>-->
...
<!--            </div>-->
<!--        </div>-->
<!--        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__L4gHxnmPDt__; ?>-->
<!--    </div>-->
<!--</div>-->
<!--&lt;!&ndash; E 推荐下载 &ndash;&gt;-->
